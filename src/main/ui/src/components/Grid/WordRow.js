...
const renderRows = (userGuess, isCurrentRow, previousGuess, wordCorrectness, setWordCorrectness, guessIndex, rowIndex) => {
    const rows = [];
...
const WordRow = ({ userGuess, isCurrentRow, previousGuess, wordCorrectness, setWordCorrectness, guessIndex, rowIndex }) => {
    return (
        <div className="WordRow">
            {renderRows(userGuess, isCurrentRow, previousGuess, wordCorrectness, setWordCorrectness, guessIndex, rowIndex)}
        </div>
    );
}
